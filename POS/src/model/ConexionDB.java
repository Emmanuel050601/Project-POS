...
public class ConexionDB {
    ...
    public static Connection getConexion(){
        String conexionUrl = "jdbc:sqlserver://localhost:1433;"
                ...
                + "user=BRANDON;"//Se modifica depediendo del nombre de usuario para conectar a la base de datos
                + "password= 2505;"//Se modifica dependiendo de la contrasena que se tiene para el usuario
